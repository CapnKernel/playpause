 ...
 */
#define USB_CFG_VENDOR_NAME     'a', 'f', 'o', 'r', 'k', '.', 'c', 'o', 'm'
 ...
 * details.
 */
#define USB_CFG_DEVICE_NAME     'M', 'e', 'd', 'i', 'a', ' ', 'p', 'l', 'a', 'y', '/', 'p', 'a', 'u', 's', 'e', ' ', 'b', 'u', 't', 't', 'o', 'n'
#define USB_CFG_DEVICE_NAME_LEN 23
/* Same as above for the device name. If you don't want a device name, undefine
 * the macros. See the file USB-IDs-for-free.txt before you assign a name if
 * you use a shared VID/PID.
 */
#define USB_CFG_SERIAL_NUMBER   'a', 'f', 'o', 'r', 'k', '.', 'c', 'o', 'm', ':'
 ...
 */
#define USB_CFG_HID_REPORT_DESCRIPTOR_LENGTH    30
